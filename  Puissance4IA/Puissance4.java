...
public class Puissance4 {
	/**
     * La dimension horizontale de la grille de jeu utilisée : celle-ci n'est pas modifiable et ne dépend pas de l'instance utilisée.
     */
	public final static int dimensionH = 7;

	/**
     * La dimension verticale de la grille de jeu utilisée : celle-ci n'est pas modifiable et ne dépend pas de l'instance utilisée.
     */
	public final static int dimensionV = 6;
	
	/**
     * Le nombre de pions à aligner pour gagner : celui-ci n'est pas modifiable et ne dépend pas de l'instance utilisée.
     */
