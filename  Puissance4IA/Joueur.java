...
public class Joueur {
     ...
     * 
     * @param adversaire
     *            L'adversaire est un joueur, fixé au moment du lancement d'un jeu (c'est-à-dire
     *            dans la méthode jouer() de la classe Puissance4).
     *            
    ...
    /** Renvoie, sous fome de String, une représentation du joueur
     * 
     * @return Renvoie, sous forme de String, une représentation du joueur
     */
    @Override
     ...
     *  temps, ce qui forcerait ici à créer plusieurs instance du même joueur.
     *
     *  @param objet
    ...
    /**
     * Méthode abstraite permettant au joueur de savoir où il jouera
     * 
     * @param grille
     *			La grille est la grille courante du jeu de puisssance 4.
     *            
     * @param scanner
     * 			Un outil de la classe Scanner permettant à l'ordinateur de dialoguer avec les joueurs humain.	
     * 
     * @see Grille
     * @see Puissance4#jouer(Scanner)
     */
